...
def test_add_contact(app):
    ...
    input_contact = Contact(firstname="Иван", middlename="Иванович", lastname="Иванов", nickname="Ваня",
                               companyname="Иван и Ко", address="посёлок Иваново", homenumber="543-66-12",
                               mobilenumber="12345678", worknumber="+7(456)1-14-15", email1="mail@ivan.io",
                               email2="ivanov@ivan.io", birth_date="//div[@id='content']/form/select[1]//option[16]",
                               ...
                               secondarynumber="(098)76543", notes="Текст заметки")
